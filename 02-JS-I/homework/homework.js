...
function redondearNumero(num) {
  ...
  // Tu código:
  var redondearMasProximo = Math.round(num);
  return redondearMasProximo;
}

function redondearHaciaArriba(num) {
  // Redondea "num" hacia arriba (al próximo entero) y devuélvelo
  // Tu código:
  var redondearMasElevado = Math.ceil(num);
  return redondearMasElevado;
}
